    ...
    <div>
      ...
      <form ref="personalInfoForm" @submit.prevent="submitForm('personalInfoForm')">        
        ...
        <div>
          ...
          <input type="text" id="full-name" v-model="form.Name" />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="text" id="account-number" v-model="form.prof_ID" />
        </div>
        <div>
          <label for="course">Program:</label>
          <input type="text" id="Prog" v-model="form.Prog" />
        </div>
        <div>
  ...
  export default {
    ...
    methods: {
      submitForm(formnName) {
        ...
        const prof_ID = this.form.prof_ID;
        axios.put(`http://localhost:8000/profDetails/update/${prof_ID}`, this.form)
        .then(response => {
